...
##### Function for the sample size calculation for the procedure 1
#############################################################################
...
##### Function for the sample size calculation for the procedure 2
#############################################################################
...
### save results###
saveRDS(fit1,"D:/Users/liangm8/Documents/BayesianClinicalTrial/03results/data1.rds")
saveRDS(fit2,"D:/Users/liangm8/Documents/BayesianClinicalTrial/03results/data2.rds")
...
p1<-ggplot(data=data, aes(x=fit.delta, y=fit.alpha1)) +
  geom_line()+
  geom_point()+
  xlab("Fraction of historical data")+
  theme(axis.text = element_text(size = 10))+
  theme_bw()+ theme(axis.text = element_text(size = 10))+
  labs(title="", y = "alpha")

p2<-ggplot(data=data, aes(x=fit.delta, y=fit.power1)) +
  geom_line()+
  geom_point()+
  xlab("Fraction of historical data")+
  theme(axis.text = element_text(size = 10))+
...
png("plot.png",width = 600,height = 600,res = 90)
